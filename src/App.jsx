  ...
  const reachFunctions = {
    ...
    dedicatedAttach: async (contractInfo) => {
      ...
      try {
        ...
        console.log(error)
        return {
          error: error.message.includes('Not Deployer')? 'not deployer' : 'Failed to fetch'
        }
      }
    },
  }
      ...
      <div>
          ...
          <div className='home'>
...

              {
                ...
                <SetCampaignDetails deploy={reachFunctions.deploy} goBack={() => setView(views.CROWD_FUND)}/>
              }
              ...
              <div className='campaign-grid'>
                 {
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems:'center' }}>
                    ...
                    <button className='button' onClick={fetchCampaigns}>Retry</button>
                  </div>
                  :
                  cards.length === 0 ?
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems:'center' }}>
                    <h3 className='no-campaigns-yet'>No Campaigns Yet</h3>
                    <button className='button' onClick={fetchCampaigns}>Reload</button>
                  </div>
                  : 
                  cards
                 }
